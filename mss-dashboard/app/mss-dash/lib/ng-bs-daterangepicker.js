...
(function(angular) {
    ...
    angular.module('ngBootstrap', []).directive('myCalendar', function($compile, $parse) {
        return {
            restrict: 'A',
            require: '?ngModel',
            scope: {
            ...
            link: function($scope, element, attributes, ngModel) {
                ...
                ngModel.formatted = function() {
                    if (!ngModel.$viewValue || !ngModel.$viewValue.startDate)
                        return "";
                    return (formatted(ngModel.$viewValue));
                }
                $scope.$watch(attributes.ngModel, function(modelValue) {
                    ...
                    var c = element.data('daterangepicker');
                ...
                $scope.$parent[attributes.myCalendar] = element.data('daterangepicker');
            }
        };
    });
